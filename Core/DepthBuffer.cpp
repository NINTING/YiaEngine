...
namespace YiaEngine
{
	namespace Graphic
	{
		...
		{
			auto desc = DescribeTex2D(width, Height,format, 1, 0, D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL);
			ClearState clearState;
			clearState.DepthStencilClearValue.Depth = 1;
			clearState.DepthStencilClearValue.Stencil = 0;
