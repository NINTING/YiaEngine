...
//using namespace YiaEngine::Graphic;
...
//
//	GetHardwareAdapter1(factory.Get(), &hardwareAdapter, false);
...
//	ThrowIfFailed(factory->CreateSwapChain(Graphic::g_commandManager.GetQueue(D3D12_COMMAND_LIST_TYPE_DIRECT).NativeCommandQueue(), &swapChainDesc, &swapChain));
//
...
//		ThrowIfFailed(hr);*/
//
//		CompilerShader(L"Shader/SampleShader.hlsl", "VSMain", "vs_5_0", &vertexShader);
//		CompilerShader(L"Shader/SampleShader.hlsl", "PSMain", "ps_5_0", &pixelShader);
//
//
...
//
//		
//		//YiaEngine::AssetLoder::Instance()->LoadModel("Fox/Fox.gltf", &mesh_);
...
//
//		
//		Graphic::VertexAttribute layout[] =
//		{
//			Graphic::VertexAttribute(VertexAttributeType::kPosition,DataFormat::kFloat_3),
//			Graphic::VertexAttribute(VertexAttributeType::kTexcoord0,DataFormat::kFloat_2),
//		};
//		mesh_.SetVertexAttributes(6, 2, layout);
//		mesh_.SetVertexData(VertexAttributeType::kPosition, pos);
//		mesh_.SetVertexData(VertexAttributeType::kTexcoord0, uv);
//	
//		auto positiones = mesh_.Positions();
//		auto uvs = mesh_.Uv0();
//		//	auto normals = mesh_.GetNormal();
//
//
//
//		BindVertexAttribute(positiones.Data, positiones.DataSize, positiones.Stride, 0);
//
//		BindVertexAttribute(uvs.Data, uvs.DataSize, uvs.Stride, 1);
//		//BindVertexAttribute(normals.data(), normals.data_size(), normals.stride(), 2);
//
//		//BindIndexBuffer(mesh_.IndexData(), mesh_.IndexCount());
//		
...
//		editor_camera.Front(Math::Vec3f(-1.f, 0.f, 0.f));
...
//
//
//		g_BundleList->DrawIndexedInstanced(mesh_.IndexCount(), 1, 0, 0, 0);
//		g_BundleList->Close();
//	}
//
//	{
...
//	drawSceneContext.TransitionBarrier(Graphic::g_SwapRenderTarget[g_frameIndex], D3D12_RESOURCE_STATE_RENDER_TARGET);
...
//	drawSceneContext.SetRenderTarget(Graphic::g_SwapRenderTarget[g_frameIndex].RtvCpuHandlePtr(), nullptr);
//	const float clearColor[] = { 0.0f, 0.2f, 0.4f, 1.0f };
//	//drawSceneContext.ClearRenderTarget(sceneTarget.RtvCpuHandle(), clearColor);
//	drawSceneContext.ClearRenderTarget(Graphic::g_SwapRenderTarget[g_frameIndex].RtvCpuHandle(), clearColor);
...
//
//
//	//drawSceneContext.DrawIndexInstance(mesh_.IndexCount(), 1, 0, 0, 0);
//	drawSceneContext.DrawInstance(mesh_.VertexCount(),1); 
...
//	drawSceneContext.TransitionBarrier(Graphic::g_SwapRenderTarget[g_frameIndex], D3D12_RESOURCE_STATE_PRESENT);
...
//}
//
//void App::BindVertexAttribute(void* data, size_t data_size, UINT stride, int index)
//{
